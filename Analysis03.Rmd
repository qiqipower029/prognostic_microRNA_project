...
```{r grade combination}
biopsy.grade$grades = ifelse(biopsy.grade$`Biopsy Grade Group` <= 2, "low", "high")
```
...
We firstly want to build logistic regression model
```{r logistic regresiion for biopsy grade group}
